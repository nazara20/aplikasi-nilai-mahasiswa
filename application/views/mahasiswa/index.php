  ...
  <div class="container-fluid">
    ...
    <div class="text-center">
      ...
      <div class="row align-items-start">
        <div class="col">
          <a href="<?= base_url('nilai'); ?>" class="btn btn-info btn-sm mt-5 mb-3 mr-1 float-left">&nbsp;&nbsp;Data Nilai Mahasiswa</a>
        </div>
        <div class="col">
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="row mb-2">
          ...
          <div class="mr-3 mt-2">
            <a href="<?= base_url('auth/logout');?>" class="text-white"><strong>LOG OUT</strong></a>
          </div>
        </div>
